...
def start_browser():
    ...
    for i in data:
        ...
        # заполняем форму
        driver.find_element(by=By.XPATH, value='/html/body/main/div[2]/div/div/div/form/div[2]/div[2]/div/input').send_keys(name)
        driver.find_element(by=By.XPATH, value='/html/body/main/div[2]/div/div/div/form/div[3]/div[2]/div/input').send_keys(email)
        driver.find_element(by=By.XPATH, value='/html/body/main/div[2]/div/div/div/form/div[4]/div[2]/div/div/input').send_keys(password)
